...
$content = file_get_contents('php://input');
  ...
  if($id==$queryfromdb1)
  {
     ...
     $arrayPostData['messages'][0]['contents'] = "สวัสดีจ้าาา".$name1;
       ...
       $arrayPostData['messages'][0]['contents'][0]['body'][1]['contents'][0]['style'] = "primary";
       $arrayPostData['messages'][0]['contents'][0]['body'][1]['contents'][0]['height'] = "sm";
       $arrayPostData['messages'][0]['contents'][0]['body'][1]['contents'][1]['action'][0]['type'] = "uri";
       $arrayPostData['messages'][0]['contents'][0]['body'][1]['contents'][1]['action'][1]['label'] = "สมัคร";
       $arrayPostData['messages'][0]['contents'][0]['body'][1]['contents'][1]['action'][1]['uri'] = "https://erp.wealththai.net/quickregister??".$id;
