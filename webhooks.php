...
$content = file_get_contents('php://input');
  ...
  if($id==$queryfromdb1)
  {
    ...
    $arrayPostData['messages'][4]['template'][2]['actions'][1]['label'] = "Tap Tap";
    $arrayPostData['messages'][4]['template'][3]['actions'][2]['uri'] = "https://example.com";
    $arrayPostData['messages'][4]['template'][4]['title'] = "Tap kiki";
    $arrayPostData['messages'][4]['template'][5]['text'] ="Tap EiEi";
